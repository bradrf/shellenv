...
function file_sum()
{
    find "$@" -type f -print0 | xargs -0 ls -al | \
        awk '{i+=1;t+=$5};END{if(t>1099511627776){d=1099511627776;u="TiB"}else if(t>1073741824){d=1073741824;u="GiB"}else if(t>1048576){d=1048576;u="MiB"}else if(t>1024){d=1024;u="KiB"}else{d=1;u="B"};printf "%'"'"'d files using %.2f %s\n", i, t/d, u}'
}
